...
-- 2017년 05월 15일 (월) 오후 05시 04분 15초
...
CREATE TABLE IF NOT EXISTS `courses` (
  ...
  CONSTRAINT `fk_course_department_time1`
    FOREIGN KEY (`department_time_year` , `department_time_semester`)
    REFERENCES `departments_with_time` (`year` , `semester`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_course_subject1`
    FOREIGN KEY (`subject_id` , `subject_department_id`)
    REFERENCES `subjects` (`id` , `department_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_course_course_time2`
    FOREIGN KEY (`course_time_id`)
...
CREATE TABLE IF NOT EXISTS `majors` (
  `id` CHAR(8) NOT NULL,
  `major_type_id` TINYINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `users_has_majors` (
  ...
  `major_major_type_id` TINYINT NOT NULL,
  `major_year` SMALLINT NOT NULL,
